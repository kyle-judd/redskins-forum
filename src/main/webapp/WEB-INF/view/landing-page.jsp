	...
	<div id="content" class="container">
		<div class="row justify-content-center">
			<div class="jumbotron text-center">
		  		<h1 class="display-1">Skins Talk</h1>
		  		<p class="lead">The Redskins Town Hall</p>
		  		<hr class="style14 my-4">
		  		<a class="btn btn-warning btn-lg" href="${pageContext.request.contextPath}/login" role="button">Login<i class="fas fa-user ml-2"></i></a>
		  		<a class="btn btn-warning btn-lg" href="${pageContext.request.contextPath}/register/registrationForm" role="button">Sign up<i class="fas fa-user-plus ml-2"></i></a>
			</div>
		</div>
	</div>
